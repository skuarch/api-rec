...
CREATE TABLE `affiliate_establishment` (
  ...
  UNIQUE KEY `UK_r72ghcevu3xuooeq1ee51gak1` (`establishment_id`),
...
CREATE TABLE `company` (
  ...
  KEY `FK_ki2r6mlgt261eao8ewrxm6nuu` (`freelancer_id`),
  ...
  CONSTRAINT `FK_ki2r6mlgt261eao8ewrxm6nuu` FOREIGN KEY (`freelancer_id`) REFERENCES `freelancer` (`freelancer_id`),
