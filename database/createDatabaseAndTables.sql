...
CREATE TABLE `cashier_secret_consumed` (
  ...
  `cashier_secret_consumed_amount` decimal(19,2) DEFAULT NULL,
...
CREATE TABLE `depositor` (
  ...
  KEY `UK_52f42go12pyuu46wi6fi4cxk` (`depositor_email`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `person` (
  ...
  KEY `UK_6uq8ww4ie2npi5np5jwi8quwn` (`person_type_id`),
...
CREATE TABLE `recipient` (
  ...
  KEY `UK_59r9ddvkgye5hp08n70wv84ef` (`recipient_email`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
