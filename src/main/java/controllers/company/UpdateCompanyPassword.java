 ...
 */
@Controller
public class UpdateCompanyPassword extends BaseController {
    
    private static final Logger logger = getLogger(UpdateCompanyPassword.class);
    @Autowired
    ...
    public @ResponseBody String updatePassword(@ModelAttribute UpdatePasswordBean upb, HttpServletResponse response) {
        ...
        try {
            ...
            logger.error("UpdateCompanyPassword.updatePassword", e);
