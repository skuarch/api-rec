 ...
 */
@RestController
public class CashierUpdate extends BaseController{

    @Autowired
    private CashierComponent cashierComponent;
    private static final Logger logger = getLogger(CashierUpdate.class);    
    @Autowired
    ...
    public @ResponseBody String updateCashier(@ModelAttribute Cashier cashier, HttpServletResponse response){
        ...
        try {
            ...
            logger.error("CashierUpdate.updateCashier", e);
