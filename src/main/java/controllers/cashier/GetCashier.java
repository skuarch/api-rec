...
import controllers.affiliate.UpdateAffiliate;
 ...
 */
@RestController
public class GetCashier extends BaseController {

    @Autowired
    private CashierComponent cashierComponent;
    private static final Logger logger = getLogger(UpdateAffiliate.class);
    ...
    public @ResponseBody String getCashier(@ModelAttribute Cashier cashier, HttpServletResponse response) {
        ...
        try {
            ...
            logger.error("GetCashier.getCashier", e);
