 ...
 */
@Controller
public class FreelancerUpdateAffiliatePassword extends BaseController {
    
    private static final Logger logger = getLogger(FreelancerUpdateAffiliatePassword.class);
    @Autowired
    private AffiliateComponent affiliateComponent;

    //==========================================================================    
    @RequestMapping(value = {"/v1/freelancer/update/affiliate/password", "v1/freelancer/update/affiliate/password"})
