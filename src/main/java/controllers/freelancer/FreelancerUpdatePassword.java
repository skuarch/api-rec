 ...
 */
@RestController
public class FreelancerUpdatePassword extends BaseController {

    private static final Logger logger = getLogger(FreelancerUpdatePassword.class);
    ...
    String updatePassword(@ModelAttribute UpdatePasswordBean upb, HttpServletResponse response) {
        ...
        try {
            ...
            TransactionUtil.createTransaction(Constants.TRANSACTION_UPDATE_FREELANCER_PASSWORD, freelancer.getId());
